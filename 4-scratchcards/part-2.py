...
if __name__ == "__main__":
    ...
    for idx, each_card in enumerate(card_data):
        card_num = idx + 1
        num_copy_scratchcards = score_my_winning_numbers(each_card[0], each_card[1])            # score for this scratchcard
        ...
        while instances[idx] > 0:                                                               # are there any unprocessed copies of this scratchcard
            num_copy_scratchcards = score_my_winning_numbers(each_card[0], each_card[1])        # score for (copy) scratchcard
